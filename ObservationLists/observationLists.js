...
{
        getObservationLists = `select name, description, '0' as number_objects, '0' as number_Observed_Objects, to_char(creationDate, 'DD/MM/YYYY') as creation_date from observationList`;
